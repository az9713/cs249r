# Module 02_activations - Activation Functions Test Report
...
## Commands Run
1. `python ./bin/tito module test 02_activations -v`
2. `python -m pytest tests/02_activations --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/02_activations/` included in the full-suite log.
