# Module 18_memoization - Memoization / KV Cache Test Report
...
## Commands Run
1. `python ./bin/tito module test 18_memoization -v`
2. `python -m pytest tests/18_memoization --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/18_memoization/` included in the full-suite log.
