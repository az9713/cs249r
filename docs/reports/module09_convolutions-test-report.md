# Module 09_convolutions - Convolutions Test Report
...
## Commands Run
1. `python ./bin/tito module test 09_convolutions -v`
2. `python -m pytest tests/09_convolutions --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/09_convolutions/` included in the full-suite log.
