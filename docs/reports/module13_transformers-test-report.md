# Module 13_transformers - Transformers Test Report
...
## Commands Run
1. `python ./bin/tito module test 13_transformers -v`
2. `python -m pytest tests/13_transformers --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/13_transformers/` included in the full-suite log.
