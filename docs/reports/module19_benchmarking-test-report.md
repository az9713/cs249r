# Module 19_benchmarking - Benchmarking Test Report
...
## Commands Run
1. `python ./bin/tito module test 19_benchmarking -v`
2. `python -m pytest tests/19_benchmarking --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/19_benchmarking/` included in the full-suite log.
