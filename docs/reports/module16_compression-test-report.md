# Module 16_compression - Compression Test Report
...
## Commands Run
1. `python ./bin/tito module test 16_compression -v`
2. `python -m pytest tests/16_compression --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/16_compression/` included in the full-suite log.
