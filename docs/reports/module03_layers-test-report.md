# Module 03_layers - Layer Composition Test Report
...
## Commands Run
1. `python ./bin/tito module test 03_layers -v`
2. `python -m pytest tests/03_layers --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/03_layers/` included in the full-suite log.
