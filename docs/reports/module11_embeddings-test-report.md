# Module 11_embeddings - Embeddings Test Report
...
## Commands Run
1. `python ./bin/tito module test 11_embeddings -v`
2. `python -m pytest tests/11_embeddings --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/11_embeddings/` included in the full-suite log.
