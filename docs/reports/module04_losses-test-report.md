# Module 04_losses - Loss Functions Test Report
...
## Commands Run
1. `python ./bin/tito module test 04_losses -v`
2. `python -m pytest tests/04_losses --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/04_losses/` included in the full-suite log.
