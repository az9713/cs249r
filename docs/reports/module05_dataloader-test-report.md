# Module 05_dataloader - Data Loading Test Report
...
## Commands Run
1. `python ./bin/tito module test 05_dataloader -v`
2. `python -m pytest tests/05_dataloader --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/05_dataloader/` included in the full-suite log.
