# Module 07_optimizers - Optimizers Test Report
...
## Commands Run
1. `python ./bin/tito module test 07_optimizers -v`
2. `python -m pytest tests/07_optimizers --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/07_optimizers/` included in the full-suite log.
