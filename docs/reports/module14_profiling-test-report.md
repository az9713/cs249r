# Module 14_profiling - Profiling & Performance Test Report
...
## Commands Run
1. `python ./bin/tito module test 14_profiling -v`
2. `python -m pytest tests/14_profiling --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/14_profiling/` included in the full-suite log.
