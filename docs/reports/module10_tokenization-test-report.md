# Module 10_tokenization - Tokenization Test Report
...
## Commands Run
1. `python ./bin/tito module test 10_tokenization -v`
2. `python -m pytest tests/10_tokenization --tinytorch --no-cov`\n
## Results
...
- Pytest transcript for `tests/10_tokenization/` included in the full-suite log.
